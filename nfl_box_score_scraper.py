...
url = 'https://www.espn.com/nfl/boxscore?gameId=401127913'
...
qb_with_most_yds_name = page_soup.select('#gamepackage-passing .name a span')[0].text
...
qb_with_most_yds_qbr = page_soup.select('#gamepackage-passing tbody .qbr')[0].text
...
team_qb_c_att = page_soup.select('#gamepackage-passing tbody .c-att')[1].text
team_qb_yds = page_soup.select('#gamepackage-passing tbody .yds')[1].text
team_qb_avg = page_soup.select('#gamepackage-passing tbody .avg')[1].text
team_qb_td = page_soup.select('#gamepackage-passing tbody .td')[1].text
team_qb_int = page_soup.select('#gamepackage-passing tbody .int')[1].text
team_qb_sacks = page_soup.select('#gamepackage-passing tbody .sacks')[1].text
team_qb_rtg = page_soup.select('#gamepackage-passing tbody .rtg')[1].text
...
qb_with_most_yds_name = page_soup.select('#gamepackage-passing .name a span')[2].text
...
qb_with_most_yds_qbr = page_soup.select('#gamepackage-passing tbody .qbr')[2].text
...
team_qb_c_att = page_soup.select('#gamepackage-passing tbody .c-att')[3].text
team_qb_yds = page_soup.select('#gamepackage-passing tbody .yds')[3].text
team_qb_avg = page_soup.select('#gamepackage-passing tbody .avg')[3].text
team_qb_td = page_soup.select('#gamepackage-passing tbody .td')[3].text
team_qb_int = page_soup.select('#gamepackage-passing tbody .int')[3].text
team_qb_sacks = page_soup.select('#gamepackage-passing tbody .sacks')[3].text
team_qb_rtg = page_soup.select('#gamepackage-passing tbody .rtg')[3].text
team_qb_c_att = str.split(team_qb_c_att, '/')
team_qb_c, team_qb_att = team_qb_c_att[0], team_qb_c_att[1]
team_qb_sacks = str.split(team_qb_sacks, '-')
team_qb_sack_number = team_qb_sacks[0]
